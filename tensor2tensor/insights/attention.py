...
class Attention():
  def get_attentions_ds(self, inp_text, out_text, enc_atts, dec_atts, encdec_atts):
    enc_att, dec_att, encdec_att = (self._resize(enc_atts),
                                    self._resize(dec_atts), self._resize(encdec_atts))
  ...
  def _show_attention(self, att_json):
  ...
  def _resize(self, att_mat, max_length=None):
  ...
  def _get_attention(self, inp_text, out_text, enc_atts, dec_atts, encdec_atts):
